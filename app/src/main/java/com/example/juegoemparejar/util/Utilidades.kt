...
val cardsComida = mutableListOf(
    Carta(10, R.drawable.pizza_svgrepo_com),
    Carta(11, R.drawable.banana_blackbarry_blackberries_svgrepo_com),
    Carta(12, R.drawable.cupcake_svgrepo_com),
    Carta(13, R.drawable.donut_svgrepo_com),
    Carta(14, R.drawable.orange_svgrepo_com),
    Carta(15, R.drawable.cerejas_cherries_cherry_svgrepo_com),
    Carta(16, R.drawable.fruit_melancia_watermelon_svgrepo_com),
    Carta(17, R.drawable.hamburger_svgrepo_com),
    Carta(110, R.drawable.pizza_svgrepo_com),
    Carta(111, R.drawable.banana_blackbarry_blackberries_svgrepo_com),
    Carta(112, R.drawable.cupcake_svgrepo_com),
    Carta(113, R.drawable.donut_svgrepo_com),
    Carta(114, R.drawable.orange_svgrepo_com),
    Carta(115, R.drawable.cerejas_cherries_cherry_svgrepo_com),
    Carta(116, R.drawable.fruit_melancia_watermelon_svgrepo_com),
    Carta(117, R.drawable.hamburger_svgrepo_com),
)
val cardsPais = mutableListOf(
    Carta(20, R.drawable.anonymous_flag_of_canada),
    ...
    Carta(28, R.drawable.zelus_et_radix_flag_of_colombia),
    Carta(120, R.drawable.anonymous_flag_of_canada),
